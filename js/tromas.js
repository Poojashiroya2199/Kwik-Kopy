$(document).ready(function(){
	...
	$(".color1" ).click(function(){
		$(".logo img" ).attr("src", "./../frontend/src/images/logo.png" );
		return false;
	});
	
	$(".color2" ).click(function(){
		$(".logo img" ).attr("src", "./../frontend/src/images/logo2.png" );
		return false;
	});
	$(".color3" ).click(function(){
		$(".logo img" ).attr("src", "./../frontend/src/images/logo3.png" );
		return false;
	});
	$(".color4" ).click(function(){
		$(".logo img" ).attr("src", "./../frontend/src/images/logo4.png" );
		return false;
	});
	$(".color5" ).click(function(){
		$(".logo img" ).attr("src", "./../frontend/src/images/logo5.png" );
		return false;
	});
	$(".color6" ).click(function(){
		$(".logo img" ).attr("src", "./../frontend/src/images/logo6.png" );
		return false;
	});
	
	$(".color7" ).click(function(){
		$(".logo img" ).attr("src", "./../frontend/src/images/logo7.png" );
		return false;
	});
	
	$(".color8" ).click(function(){
		$(".logo img" ).attr("src", "./../frontend/src/images/logo8.png" );
		return false;
	});
